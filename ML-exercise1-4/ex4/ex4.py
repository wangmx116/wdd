...
print('X shape', X.shape) #(5000, 400)
print('y shape', y.shape) #(5000, 1)
...
#print('Theta1,2 shape', Theta1.shape, Theta2.shape)

y = np.squeeze(y)
#print('y shape', y.shape)

# Unroll parameters 
nn_params = np.hstack((Theta1.T.ravel(), Theta2.T.ravel())) #(25*401+10*26, )
